class ProductForm extends HTMLElement {
  ...
  onSubmitHandler(evt) {
    ...
    fetch(`/cart/add.js`, this.handleFetchConfig())
  ...
  handleFetchConfig() {
    ...
    let body = { 
      items: [
        ...
        { id: productOwnerId, quantity: 1, properties: { "_pairedProduct": pairedProductPropValue } }
      ]
    }
...
customElements.define('paired-product-form', PairedProductForm)